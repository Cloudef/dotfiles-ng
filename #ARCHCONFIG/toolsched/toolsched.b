#!/bin/bash
# toolsched.b v0.17 by Con Kolivas <kernel@kolivas.org>

# Check we're only calling this as a symbolic link
if [[ ! -h $0 ]]; then
	echo "Calling toolsched.b directly, aborting!"
...
# make this script SCHED_BATCH thus if it succeeds the command will also
# run SCHED_BATCH.
